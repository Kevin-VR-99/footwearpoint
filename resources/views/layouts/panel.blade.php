...
>
    ...
    <div class="min-h-screen flex">
            ...
            <div class="flex h-full w-64 flex-col">
                ...
                <div class="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-4">
                    <a href="{{ route('dashboard') }}" wire:navigate class="group flex min-w-0 items-center gap-2.5">
                        <span class="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/10 ring-2 ring-fp-primary/35 transition group-hover:ring-fp-primary/60">
                            <img
                        ...
                        <span class="min-w-0 leading-tight">
                            <span class="block truncate text-sm font-semibold tracking-tight text-white">Footwear Point</span>
                            <span class="block text-[10px] font-medium uppercase tracking-[0.14em] text-white/45">Distribuidora</span>
                        </span>
                    </a>
                    <button
                        type="button"
                ...
                <nav class="flex-1 space-y-1 overflow-y-auto p-3">
                    ...
                    <a href="{{ route('dashboard') }}"
                       ...
                       class="group flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm transition {{ request()->routeIs('dashboard') ? 'bg-fp-primary/25 font-semibold text-white shadow-sm ring-1 ring-fp-primary/30' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                        <span class="flex h-7 w-7 items-center justify-center rounded-lg {{ request()->routeIs('dashboard') ? 'bg-fp-primary text-white' : 'bg-white/10 text-white/70 group-hover:bg-white/15 group-hover:text-white' }}">
                    ...
                    @if ($esAdminDistribuidora)
                        <div class="pt-2">
                            <p class="px-3 pb-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/35">Gestión</p>
                            <button
                                type="button"
                            ...
                            >
                                ...
                                <svg class="h-4 w-4 text-white/45 transition-transform" :class="openCatalogo && 'rotate-180'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            <div x-show="openCatalogo" x-cloak class="ml-3 mt-0.5 space-y-0.5 border-l border-white/10 pl-2">
                    ...
                    {{-- Operación --}}
                    <div class="pt-2">
                        <p class="px-3 pb-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/35">Operación</p>
                        <button
                            type="button"
                            class="flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-sm text-white/80 transition hover:bg-white/10 hover:text-white"
                        ...
                        >
                            <span class="flex items-center gap-2.5 font-medium text-white/90">
                                <span class="flex h-7 w-7 items-center justify-center rounded-lg bg-white/10">
                                    <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 7h18M5 7l1.5 12h11L19 7M9 7V5a3 3 0 016 0v2" />
                                    </svg>
                                </span>
                                Menú
                            </span>
                            <svg class="h-4 w-4 text-white/45 transition-transform" :class="openOperacion && 'rotate-180'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="openOperacion" x-cloak class="ml-3 mt-0.5 space-y-0.5 border-l border-white/10 pl-2">
                            ...
                            <a href="{{ route('punto-venta.index') }}" wire:navigate
                               class="block rounded-lg px-3 py-2 text-sm transition {{ request()->routeIs('punto-venta.*') ? 'bg-white/15 font-medium text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">Punto de Venta</a>
                            <a href="{{ route('ciclo.index') }}" wire:navigate
                               class="block rounded-lg px-3 py-2 text-sm transition {{ request()->routeIs('ciclo.*') ? 'bg-white/15 font-medium text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">Ciclo de compra</a>
                    ...
                    {{-- Más --}}
                    <div class="pt-2">
                        <p class="px-3 pb-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/35">Más</p>
                        <button
                            type="button"
                            class="flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-sm text-white/80 transition hover:bg-white/10 hover:text-white"
                        ...
                        >
                            ...
                            <svg class="h-4 w-4 text-white/45 transition-transform" :class="openMas && 'rotate-180'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    @if ($esAdminDistribuidora)
                        <div class="pt-2">
                            <p class="px-3 pb-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/35">Sistema</p>
                            <button
                                type="button"
                                class="flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-sm text-white/80 transition hover:bg-white/10 hover:text-white"
                            ...
                            >
                                ...
                                <svg class="h-4 w-4 text-white/45 transition-transform" :class="openSistema && 'rotate-180'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            <div x-show="openSistema" x-cloak class="ml-3 mt-0.5 space-y-0.5 border-l border-white/10 pl-2">
        ...
        <div class="flex min-w-0 flex-1 flex-col transition-[margin] duration-200 ease-out">
            ...
            <header class="sticky top-0 z-30 border-b border-slate-200/80 bg-white/95 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/85">
                ...
                <div class="flex items-center gap-3 px-4 py-2.5 sm:px-5">
                    ...
                    >
                        <span class="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-fp-sidebar shadow-sm ring-2 ring-fp-primary/20 transition group-hover:ring-fp-primary/40">
                            <img
                                src="{{ asset('brand/logo-mark-white-40.png') }}"
                                alt=""
                        ...
                        <span class="min-w-0">
                            <span class="block truncate text-sm font-semibold tracking-tight text-fp-sidebar">Footwear Point</span>
                            <span class="hidden text-[10px] font-medium uppercase tracking-[0.14em] text-fp-text-muted sm:block">Panel</span>
                        </span>
                    </button>
                        ...
                        <div class="relative" @click.outside="userMenuOpen = false">
                            ...
                            >
                                @if ($logotipoDistribuidora)
                                    ...
                                    >
                                @else
                                    <span class="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-fp-sidebar to-fp-accent text-[11px] font-semibold text-white ring-2 ring-fp-primary/15">
                                        {{ $iniciales }}
                                    </span>
                                @endif
                                <span class="hidden min-w-0 max-w-[10rem] sm:block">
                                    <span class="block truncate text-sm font-medium text-fp-sidebar">{{ $nombreUsuario }}</span>
                                </span>
                                <svg class="h-4 w-4 text-slate-400 transition-transform" :class="userMenuOpen && 'rotate-180'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            ...
                            <div
                                ...
                                role="menu"
                            >
                                <div class="border-b border-slate-100 bg-gradient-to-r from-fp-sidebar to-fp-accent px-3.5 py-3">
